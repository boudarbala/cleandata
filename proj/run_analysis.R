...
<html lang="en" class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>Getting-and-Cleaning-Data-Project/run_analysis.R at master · gralic/Getting-and-Cleaning-Data-Project</title>
...
<meta content="ZXP6s6Cct3uuw8+Iz8Ny4QokB6r5pu4PyXXsJ0XoMdu55eCCqWrQunb8FCpBHIC5FpNoJP/nvLZgMAKse1YBaw==" name="csrf-token" />
...
<ul class="dropdown-menu">
  ...
  <li class="header-nav-item">
    <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="1KvFXrmij+Z7g8+7JPLcehJm8ZX51I9Gye7YZvDe4wigFfd/bOqyp6aEBk6oQXfEqtYNTel+3zd9hQYd1R1sTw==" /></div>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="7wuzCMom24PHVkKHbhKJjnQheArDpXPytmOL4JnhG9bKNGqO52j00n0aB11hQl1uX1kzc52HhDsN9EHm53ocIQ==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="18871636" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/gralic/Getting-and-Cleaning-Data-Project/unstar" class="js-toggler-form starred js-unstar-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="egfmvGzkG2IebD1L5GoXyNEIoDRBgZb2ac7eoMIkevdcBtn/0CIYOb4755HdUHuC+Ueuzvq8Un4asQUvtSbh5w==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/gralic/Getting-and-Cleaning-Data-Project/star" class="js-toggler-form unstarred js-star-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="s07EDUWnotDOriiPvSjF8oM3ff0v08m0LNaQ6uXPMacGMmQvUszjS7A57zTuM27/pZbtvHBLptZ1YXKq/13fgQ==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
...
<a href="/gralic/Getting-and-Cleaning-Data-Project/blob/c9d56d5fb0f3080f7993e5b9cdd4b300369c6b35/run_analysis.R" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:017fdff06272025fd1dbb91f83a1a13a -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/gralic/Getting-and-Cleaning-Data-Project/blob/master/run_analysis.R"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
...
<div class="file-box">
  <div class="file">
    <div class="meta clearfix">
      <div class="info file-name">
          <span>67 lines (53 sloc)</span>
          <span class="meta-divider"></span>
        <span>2.193 kb</span>
      </div>
      <div class="actions">
        <div class="button-group">
          <a href="/gralic/Getting-and-Cleaning-Data-Project/raw/master/run_analysis.R" class="minibutton " id="raw-url">Raw</a>
            <a href="/gralic/Getting-and-Cleaning-Data-Project/blame/master/run_analysis.R" class="minibutton js-update-url-with-hash">Blame</a>
          <a href="/gralic/Getting-and-Cleaning-Data-Project/commits/master/run_analysis.R" class="minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->

          <a class="octicon-button tooltipped tooltipped-nw"
             href="github-windows://openRepo/https://github.com/gralic/Getting-and-Cleaning-Data-Project?branch=master&amp;filepath=run_analysis.R" aria-label="Open this file in GitHub for Windows">
              <span class="octicon octicon-device-desktop"></span>
          </a>

              <a class="octicon-button tooltipped tooltipped-n js-update-url-with-hash"
                 aria-label="Clicking this button will fork this project so you can edit the file"
                 href="/gralic/Getting-and-Cleaning-Data-Project/edit/master/run_analysis.R"
                 data-method="post" rel="nofollow"><span class="octicon octicon-pencil"></span></a>

            <a class="octicon-button danger tooltipped tooltipped-s"
               href="/gralic/Getting-and-Cleaning-Data-Project/delete/master/run_analysis.R"
  ...
  <div class="blob-wrapper data type-r">
      ...
      <tr>
        ...
        <td id="LC1" class="blob-line-code js-file-line"><span class="c1"># Source of data for the project:</span></td>
      </tr>
      <tr>
        <td id="L2" class="blob-line-num js-line-number" data-line-number="2"></td>
        <td id="LC2" class="blob-line-code js-file-line"><span class="c1"># https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip</span></td>
      </tr>
      <tr>
        <td id="L3" class="blob-line-num js-line-number" data-line-number="3"></td>
        <td id="LC3" class="blob-line-code js-file-line"><span class="c1"># This R script does the following:</span></td>
      </tr>
      <tr>
        <td id="L4" class="blob-line-num js-line-number" data-line-number="4"></td>
        <td id="LC4" class="blob-line-code js-file-line"><span class="c1"># 1. Merges the training and the test sets to create one data set.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC6" class="blob-line-code js-file-line">tmp1 <span class="o">&lt;-</span> read.table<span class="p">(</span><span class="s">&quot;train/X_train.txt&quot;</span><span class="p">)</span></td>
      </tr>
      <tr>
        <td id="L7" class="blob-line-num js-line-number" data-line-number="7"></td>
        <td id="LC7" class="blob-line-code js-file-line">tmp2 <span class="o">&lt;-</span> read.table<span class="p">(</span><span class="s">&quot;test/X_test.txt&quot;</span><span class="p">)</span></td>
      </tr>
      <tr>
        <td id="L8" class="blob-line-num js-line-number" data-line-number="8"></td>
        <td id="LC8" class="blob-line-code js-file-line">X <span class="o">&lt;-</span> <span class="kp">rbind</span><span class="p">(</span>tmp1<span class="p">,</span> tmp2<span class="p">)</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC10" class="blob-line-code js-file-line">tmp1 <span class="o">&lt;-</span> read.table<span class="p">(</span><span class="s">&quot;train/subject_train.txt&quot;</span><span class="p">)</span></td>
      </tr>
      <tr>
        <td id="L11" class="blob-line-num js-line-number" data-line-number="11"></td>
        <td id="LC11" class="blob-line-code js-file-line">tmp2 <span class="o">&lt;-</span> read.table<span class="p">(</span><span class="s">&quot;test/subject_test.txt&quot;</span><span class="p">)</span></td>
      </tr>
      <tr>
        <td id="L12" class="blob-line-num js-line-number" data-line-number="12"></td>
        <td id="LC12" class="blob-line-code js-file-line">S <span class="o">&lt;-</span> <span class="kp">rbind</span><span class="p">(</span>tmp1<span class="p">,</span> tmp2<span class="p">)</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC14" class="blob-line-code js-file-line">tmp1 <span class="o">&lt;-</span> read.table<span class="p">(</span><span class="s">&quot;train/y_train.txt&quot;</span><span class="p">)</span></td>
      </tr>
      <tr>
        <td id="L15" class="blob-line-num js-line-number" data-line-number="15"></td>
        <td id="LC15" class="blob-line-code js-file-line">tmp2 <span class="o">&lt;-</span> read.table<span class="p">(</span><span class="s">&quot;test/y_test.txt&quot;</span><span class="p">)</span></td>
      </tr>
      <tr>
        <td id="L16" class="blob-line-num js-line-number" data-line-number="16"></td>
        <td id="LC16" class="blob-line-code js-file-line">Y <span class="o">&lt;-</span> <span class="kp">rbind</span><span class="p">(</span>tmp1<span class="p">,</span> tmp2<span class="p">)</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC18" class="blob-line-code js-file-line"><span class="c1"># 2. Extracts only the measurements on the mean and standard deviation for each measurement.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC20" class="blob-line-code js-file-line">features <span class="o">&lt;-</span> read.table<span class="p">(</span><span class="s">&quot;features.txt&quot;</span><span class="p">)</span></td>
      </tr>
      <tr>
        <td id="L21" class="blob-line-num js-line-number" data-line-number="21"></td>
        <td id="LC21" class="blob-line-code js-file-line">indices_of_good_features <span class="o">&lt;-</span> <span class="kp">grep</span><span class="p">(</span><span class="s">&quot;-mean\\(\\)|-std\\(\\)&quot;</span><span class="p">,</span> features<span class="p">[,</span> <span class="m">2</span><span class="p">])</span></td>
      </tr>
      <tr>
        <td id="L22" class="blob-line-num js-line-number" data-line-number="22"></td>
        <td id="LC22" class="blob-line-code js-file-line">X <span class="o">&lt;-</span> X<span class="p">[,</span> indices_of_good_features<span class="p">]</span></td>
      </tr>
      <tr>
        <td id="L23" class="blob-line-num js-line-number" data-line-number="23"></td>
        <td id="LC23" class="blob-line-code js-file-line"><span class="kp">names</span><span class="p">(</span>X<span class="p">)</span> <span class="o">&lt;-</span> features<span class="p">[</span>indices_of_good_features<span class="p">,</span> <span class="m">2</span><span class="p">]</span></td>
      </tr>
      <tr>
        <td id="L24" class="blob-line-num js-line-number" data-line-number="24"></td>
        <td id="LC24" class="blob-line-code js-file-line"><span class="kp">names</span><span class="p">(</span>X<span class="p">)</span> <span class="o">&lt;-</span> <span class="kp">gsub</span><span class="p">(</span><span class="s">&quot;\\(|\\)&quot;</span><span class="p">,</span> <span class="s">&quot;&quot;</span><span class="p">,</span> <span class="kp">names</span><span class="p">(</span>X<span class="p">))</span></td>
      </tr>
      <tr>
        <td id="L25" class="blob-line-num js-line-number" data-line-number="25"></td>
        <td id="LC25" class="blob-line-code js-file-line"><span class="kp">names</span><span class="p">(</span>X<span class="p">)</span> <span class="o">&lt;-</span> <span class="kp">tolower</span><span class="p">(</span><span class="kp">names</span><span class="p">(</span>X<span class="p">))</span>  <span class="c1"># see last slide of the lecture Editing Text Variables (week 4)</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC27" class="blob-line-code js-file-line"><span class="c1"># 3. Uses descriptive activity names to name the activities in the data set</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC29" class="blob-line-code js-file-line">activities <span class="o">&lt;-</span> read.table<span class="p">(</span><span class="s">&quot;activity_labels.txt&quot;</span><span class="p">)</span></td>
      </tr>
      <tr>
        <td id="L30" class="blob-line-num js-line-number" data-line-number="30"></td>
        <td id="LC30" class="blob-line-code js-file-line">activities<span class="p">[,</span> <span class="m">2</span><span class="p">]</span> <span class="o">=</span> <span class="kp">gsub</span><span class="p">(</span><span class="s">&quot;_&quot;</span><span class="p">,</span> <span class="s">&quot;&quot;</span><span class="p">,</span> <span class="kp">tolower</span><span class="p">(</span><span class="kp">as.character</span><span class="p">(</span>activities<span class="p">[,</span> <span class="m">2</span><span class="p">])))</span></td>
      </tr>
      <tr>
        <td id="L31" class="blob-line-num js-line-number" data-line-number="31"></td>
        <td id="LC31" class="blob-line-code js-file-line">Y<span class="p">[,</span><span class="m">1</span><span class="p">]</span> <span class="o">=</span> activities<span class="p">[</span>Y<span class="p">[,</span><span class="m">1</span><span class="p">],</span> <span class="m">2</span><span class="p">]</span></td>
      </tr>
      <tr>
        <td id="L32" class="blob-line-num js-line-number" data-line-number="32"></td>
        <td id="LC32" class="blob-line-code js-file-line"><span class="kp">names</span><span class="p">(</span>Y<span class="p">)</span> <span class="o">&lt;-</span> <span class="s">&quot;activity&quot;</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC34" class="blob-line-code js-file-line"><span class="c1"># 4. Appropriately labels the data set with descriptive activity names.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC36" class="blob-line-code js-file-line"><span class="kp">names</span><span class="p">(</span>S<span class="p">)</span> <span class="o">&lt;-</span> <span class="s">&quot;subject&quot;</span></td>
      </tr>
      <tr>
        <td id="L37" class="blob-line-num js-line-number" data-line-number="37"></td>
        <td id="LC37" class="blob-line-code js-file-line">cleaned <span class="o">&lt;-</span> <span class="kp">cbind</span><span class="p">(</span>S<span class="p">,</span> Y<span class="p">,</span> X<span class="p">)</span></td>
      </tr>
      <tr>
        <td id="L38" class="blob-line-num js-line-number" data-line-number="38"></td>
        <td id="LC38" class="blob-line-code js-file-line">write.table<span class="p">(</span>cleaned<span class="p">,</span> <span class="s">&quot;merged_clean_data.txt&quot;</span><span class="p">)</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC40" class="blob-line-code js-file-line"><span class="c1"># 5. Creates a 2nd, independent tidy data set with the average of each variable for each activity and each subject.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC42" class="blob-line-code js-file-line">uniqueSubjects <span class="o">=</span> <span class="kp">unique</span><span class="p">(</span>S<span class="p">)[,</span><span class="m">1</span><span class="p">]</span></td>
      </tr>
      <tr>
        <td id="L43" class="blob-line-num js-line-number" data-line-number="43"></td>
        <td id="LC43" class="blob-line-code js-file-line">numSubjects <span class="o">=</span> <span class="kp">length</span><span class="p">(</span><span class="kp">unique</span><span class="p">(</span>S<span class="p">)[,</span><span class="m">1</span><span class="p">])</span></td>
      </tr>
      <tr>
        <td id="L44" class="blob-line-num js-line-number" data-line-number="44"></td>
        <td id="LC44" class="blob-line-code js-file-line">numActivities <span class="o">=</span> <span class="kp">length</span><span class="p">(</span>activities<span class="p">[,</span><span class="m">1</span><span class="p">])</span></td>
      </tr>
      <tr>
        <td id="L45" class="blob-line-num js-line-number" data-line-number="45"></td>
        <td id="LC45" class="blob-line-code js-file-line">numCols <span class="o">=</span> <span class="kp">dim</span><span class="p">(</span>cleaned<span class="p">)[</span><span class="m">2</span><span class="p">]</span></td>
      </tr>
      <tr>
        <td id="L46" class="blob-line-num js-line-number" data-line-number="46"></td>
        <td id="LC46" class="blob-line-code js-file-line">result <span class="o">=</span> cleaned<span class="p">[</span><span class="m">1</span><span class="o">:</span><span class="p">(</span>numSubjects<span class="o">*</span>numActivities<span class="p">),</span> <span class="p">]</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC48" class="blob-line-code js-file-line">row <span class="o">=</span> <span class="m">1</span></td>
      </tr>
      <tr>
        <td id="L49" class="blob-line-num js-line-number" data-line-number="49"></td>
        <td id="LC49" class="blob-line-code js-file-line"><span class="kr">for</span> <span class="p">(</span>s <span class="kr">in</span> <span class="m">1</span><span class="o">:</span>numSubjects<span class="p">)</span> <span class="p">{</span></td>
      </tr>
      <tr>
        <td id="L50" class="blob-line-num js-line-number" data-line-number="50"></td>
        <td id="LC50" class="blob-line-code js-file-line">	<span class="kr">for</span> <span class="p">(</span>a <span class="kr">in</span> <span class="m">1</span><span class="o">:</span>numActivities<span class="p">)</span> <span class="p">{</span></td>
      </tr>
      <tr>
        <td id="L51" class="blob-line-num js-line-number" data-line-number="51"></td>
        <td id="LC51" class="blob-line-code js-file-line">		result<span class="p">[</span><span class="kp">row</span><span class="p">,</span> <span class="m">1</span><span class="p">]</span> <span class="o">=</span> uniqueSubjects<span class="p">[</span>s<span class="p">]</span></td>
      </tr>
      <tr>
        <td id="L52" class="blob-line-num js-line-number" data-line-number="52"></td>
        <td id="LC52" class="blob-line-code js-file-line">		result<span class="p">[</span><span class="kp">row</span><span class="p">,</span> <span class="m">2</span><span class="p">]</span> <span class="o">=</span> activities<span class="p">[</span>a<span class="p">,</span> <span class="m">2</span><span class="p">]</span></td>
      </tr>
      <tr>
        <td id="L53" class="blob-line-num js-line-number" data-line-number="53"></td>
        <td id="LC53" class="blob-line-code js-file-line">		tmp <span class="o">&lt;-</span> cleaned<span class="p">[</span>cleaned<span class="o">$</span>subject<span class="o">==</span>s <span class="o">&amp;</span> cleaned<span class="o">$</span>activity<span class="o">==</span>activities<span class="p">[</span>a<span class="p">,</span> <span class="m">2</span><span class="p">],</span> <span class="p">]</span></td>
      </tr>
      <tr>
        <td id="L54" class="blob-line-num js-line-number" data-line-number="54"></td>
        <td id="LC54" class="blob-line-code js-file-line">		result<span class="p">[</span><span class="kp">row</span><span class="p">,</span> <span class="m">3</span><span class="o">:</span>numCols<span class="p">]</span> <span class="o">&lt;-</span> <span class="kp">colMeans</span><span class="p">(</span>tmp<span class="p">[,</span> <span class="m">3</span><span class="o">:</span>numCols<span class="p">])</span></td>
      </tr>
      <tr>
        <td id="L55" class="blob-line-num js-line-number" data-line-number="55"></td>
        <td id="LC55" class="blob-line-code js-file-line">		row <span class="o">=</span> <span class="kp">row</span><span class="m">+1</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC58" class="blob-line-code js-file-line">write.table<span class="p">(</span>result<span class="p">,</span> <span class="s">&quot;data_set_with_the_averages.txt&quot;</span><span class="p">)</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC60" class="blob-line-code js-file-line"><span class="c1"># res2 &lt;- read.table(&quot;data_set_with_the_averages.txt&quot;)</span></td>
      </tr>
      <tr>
        <td id="L61" class="blob-line-num js-line-number" data-line-number="61"></td>
        <td id="LC61" class="blob-line-code js-file-line"><span class="c1"># result[4,4]</span></td>
      </tr>
      <tr>
        <td id="L62" class="blob-line-num js-line-number" data-line-number="62"></td>
        <td id="LC62" class="blob-line-code js-file-line"><span class="c1"># res2[4,4]</span></td>
      </tr>
      <tr>
        <td id="L63" class="blob-line-num js-line-number" data-line-number="63"></td>
        <td id="LC63" class="blob-line-code js-file-line"><span class="c1"># res2[4,4]==result[4,4]</span></td>
      </tr>
      <tr>
        <td id="L64" class="blob-line-num js-line-number" data-line-number="64"></td>
        <td id="LC64" class="blob-line-code js-file-line"><span class="c1"># result[6,4]</span></td>
      </tr>
      <tr>
        <td id="L65" class="blob-line-num js-line-number" data-line-number="65"></td>
        <td id="LC65" class="blob-line-code js-file-line"><span class="c1"># res2[6,4]</span></td>
      </tr>
      <tr>
        <td id="L66" class="blob-line-num js-line-number" data-line-number="66"></td>
        <td id="LC66" class="blob-line-code js-file-line"><span class="c1"># res2[6,4]==result[6,4]</span></td>
      </tr>
</table>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.03646s from github-fe132-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
